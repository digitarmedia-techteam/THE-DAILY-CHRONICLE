...
export function StickyBottomAd() {
    ...
    return (
        <div
            className={`fixed bottom-0 left-0 right-0 z-40 bg-background/98 backdrop-blur-md border-t border-border/50 shadow-2xl transition-transform duration-300 ease-out ${isHiddenByScroll ? 'translate-y-full' : 'translate-y-0'
                }`}
        >
